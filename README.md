...
`gigachat` на .NET также был выполнен ИИ, поэтому возможны расхождения с исходной библиотекой
или особенности поведения, которые проявятся только в реальных интеграциях.

Если при использовании SDK вы обнаружите баг, несовместимость или неточность документации,
пожалуйста, создайте [GitHub Issue](https://github.com/h0tnanny/GigaChat-Net/issues).
